...
IP_DEP=10.248.1.93
DBUSER_DEP=root
DBPASS_DEP=itfin1020
DBNAME_DEP=cb_dep
#贷款系统
IP_LOAN=10.248.1.96
DBUSER_LOAN=root
DBPASS_LOAN=itfin1020
DBNAME_LOAN=cb_loan
#核算系统
IP_GL=10.248.1.94
DBUSER_GL=root
...
DBNAME_IA=cb_ia
#支持系统
IP_SUPP=10.248.1.100
DBUSER_SUPP=root
DBPASS_SUPP=itfin1020
DBNAME_SUPP=cb_supp
#后管系统
IP_CBMG=10.248.1.90
DBUSER_CBMG=root
DBPASS_CBMG=itfin1020
DBNAME_CBMG=co_cbmg
#批量系统
IP_BATCH=10.248.1.89
DBUSER_BATCH=root
DBPASS_BATCH=itfin1020
...
{
#存款系统备份
BAKDIR_DEP=/home/ftpuser/sbin/sqlbak/cb_dep$BAKDATE
...
{
#贷款系统备份
BAKDIR_LOAN=/home/ftpuser/sbin/sqlbak/cb_loan$BAKDATE
...
{
#资产交换系统备份
BAKDIR_AE=/home/ftpuser/sbin/sqlbak/cb_ae$BAKDATE
if [ ! -d $BAKDIR_AE ];then
    mkdir $BAKDIR_AE
fi
...
{
#核算系统备份
BAKDIR_GL=/home/ftpuser/sbin/sqlbak/cb_gl$BAKDATE
if [ ! -d $BAKDIR_GL ];then
    mkdir $BAKDIR_GL
fi
...
{
#支持系统备份
BAKDIR_SUPP=/home/ftpuser/sbin/sqlbak/cb_supp$BAKDATE
...
{
#内部帐系统备份
BAKDIR_IA=/home/ftpuser/sbin/sqlbak/cb_ia$BAKDATE
if [ ! -d $BAKDIR_IA ];then
    mkdir $BAKDIR_IA
fi
...
{
#后管系统备份
BAKDIR_CBMG=/home/ftpuser/sbin/sqlbak/co_cbmg$BAKDATE
...
{
#客户中心系统备份
BAKDIR_COL=/home/ftpuser/sbin/sqlbak/cs_col$BAKDATE
