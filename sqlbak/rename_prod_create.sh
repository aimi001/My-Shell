...
sh ~/sbin/tmp_sql.sh cb_loan ~/sbin/sqlbak/guo/tmp_loan_create.sql
mv ~/sbin/tmp_cb_loan.sql ~/sbin/sqlbak/guo/tmp_loan_create.sql
...
sh ~/sbin/tmp_sql.sh cb_dep ~/sbin/sqlbak/guo/tmp_dep_create.sql
mv ~/sbin/tmp_cb_dep.sql ~/sbin/sqlbak/guo/tmp_dep_create.sql
...
sh ~/sbin/tmp_sql.sh cb_ae ~/sbin/sqlbak/guo/tmp_ae_create.sql
mv ~/sbin/tmp_cb_ae.sql ~/sbin/sqlbak/guo/tmp_ae_create.sql
