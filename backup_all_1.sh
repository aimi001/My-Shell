...
#贷款系统
IP_LOAN=10.247.1.12
DBUSER_LOAN=base_loan
DBPASS_LOAN=base_loan
DBNAME_LOAN=base_loan
#核算系统
IP_GL=10.247.1.12
DBUSER_GL=base_gl
DBPASS_GL=base_gl
...
#支持系统
IP_SUPP=10.247.1.12
DBUSER_SUPP=base_supp
DBPASS_SUPP=base_supp
DBNAME_SUPP=base_supp
#后管系统
IP_CBMG=10.247.1.12
DBUSER_CBMG=base_cbmg
DBPASS_CBMG=base_cbmg
DBNAME_CBMG=base_cbmg
#批量系统
IP_BATCH=10.247.1.12
DBUSER_BATCH=batch
DBPASS_BATCH=batch
DBNAME1_BATCH=base_batch
DBNAME2_BATCH=base_dep_batch
DBNAME3_BATCH=base_loan_batch
DBNAME4_BATCH=base_gl_batch
DBNAME5_BATCH=base_ia_batch
#资产交换
IP_AE=10.247.1.12
DBUSER_AE=base_ae
DBPASS_AE=base_ae
...
do
    ...
    #删除当天已经备份过的文件
    rm -rf /home/ftpuser/sbin/sqlbak/banben_1_${BAKDATE}.tar.gz
    ...
    TIME=`date +%H%M`
        ...
        tar -zcvf banben_1_${BAKDATE}.tar.gz *$BAKDATE
        rm -rf *$BAKDATE
    #fi
