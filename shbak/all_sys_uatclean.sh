...
func_dep()
{
    ...
    mysql -h 10.247.1.20 -uroot -pITfin1020 -P3306 < /home/ftpuser/sbin/tmp.sql
    if [ $? -ne 0 ];then
        echo "dep error!"
        exit 1
    fi
...
func_loan()
{
    ...
    sed -i 's/truncate table/delete from/Ig' /home/ftpuser/sbin/tmp.sql
    mysql -h 10.247.1.23 -uroot -pITfin1020 -P3306 < /home/ftpuser/sbin/tmp.sql
    if [ $? -ne 0 ];then
        echo "loan error!"
        exit 1
    fi
...
func_ae()
{
    ...
    sed -i 's/truncate table/delete from/Ig' /home/ftpuser/sbin/tmp.sql
    mysql -h 10.247.1.12 -uroot -pITfin1020 -P3306 < /home/ftpuser/sbin/tmp.sql
    if [ $? -ne 0 ];then
        echo "ae error!"
        exit 1
    fi
...
func_gl()
{
    ...
    sed -i 's/truncate table/delete from/Ig' /home/ftpuser/sbin/tmp.sql
    mysql -h 10.247.1.21 -uroot -pITfin1020 -P3306 -Dcb_gl < /home/ftpuser/sbin/tmp.sql
...
func_ia()
{
    ...
    sed -i 's/truncate table/delete from/Ig' /home/ftpuser/sbin/tmp.sql
    mysql -h 10.247.1.22 -uroot -pITfin1020 -P3306 -Dcb_ia < /home/ftpuser/sbin/tmp.sql
...
func_supp()
{
    ...
    sed -i 's/truncate table/delete from/Ig' /home/ftpuser/sbin/tmp.sql
    mysql -h 10.247.1.17 -uroot -pITfin1020 -P3306 -Dcb_supp < /home/ftpuser/sbin/tmp.sql
...
func_cbmg()
{
    ...
    sed -i 's/truncate table/delete from/Ig' /home/ftpuser/sbin/tmp.sql
    mysql -h 10.247.1.8 -uroot -pITfin1020 -P3306 -Dco_cbmg < /home/ftpuser/sbin/tmp.sql
...
func_col()
{
    ...
    sed -i 's/truncate table/delete from/Ig' /home/ftpuser/sbin/tmp.sql
    mysql -h 10.247.1.19 -uroot -pITfin1020 -P3306 -Dcs_col < /home/ftpuser/sbin/tmp.sql
...
func_batch()
{
    ...
    sed -i 's/truncate table/delete from/Ig' /home/ftpuser/sbin/tmp.sql
    mysql -h 10.247.1.13 -uroot -pITfin1020 -P3306 -Dcb_batch < /home/ftpuser/sbin/tmp.sql
...
func_gl_batch()
{
    ...
    sed -i 's/truncate table/delete from/Ig' /home/ftpuser/sbin/tmp.sql
    mysql -h 10.247.1.13 -uroot -pITfin1020 -P3306 -Dcb_gl_batch < /home/ftpuser/sbin/tmp.sql
...
func_ia_batch()
{
    ...
    sed -i 's/truncate table/delete from/Ig' /home/ftpuser/sbin/tmp.sql
    mysql -h 10.247.1.13 -uroot -pITfin1020 -P3306 -Dcb_ia_batch < /home/ftpuser/sbin/tmp.sql
...
func_dep_batch()
{
    ...
    sed -i 's/truncate table/delete from/Ig' /home/ftpuser/sbin/tmp.sql
    mysql -h 10.247.1.13 -uroot -pITfin1020 -P3306 -Dcb_dep_batch < /home/ftpuser/sbin/tmp.sql
...
func_loan_batch()
{
    ...
    sed -i 's/truncate table/delete from/Ig' /home/ftpuser/sbin/tmp.sql
    mysql -h 10.247.1.13 -uroot -pITfin1020 -P3306 -Dcb_loan_batch < /home/ftpuser/sbin/tmp.sql
